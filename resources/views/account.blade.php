        ...
        <div class="container">
            ...
            <ul class="list-group">
                @foreach ($medications as $medication )
                    <li> Medication:<i style="color:green"> {{ $medication->name }} </i> Dosage:<i style="color:green"> {{ $medication->dosage }} </i>
                         Frequency: <i style="color:green">{{ $medication->frequency }} </i>
 
                        &nbsp;&nbsp;&nbsp;<a href='#'><img src="./images/pencil.png" style="margin-left:1rem"  width="10" height="10"  /> </a>
                        &nbsp;&nbsp;&nbsp;<a href='#'><img src="./images/trash.png"  width="10" height="10" style="margin-left:1rem"  /> </a>
                    </li>
                @endforeach
            </ul>
        </div>
